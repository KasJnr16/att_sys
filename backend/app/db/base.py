...
from app.models.user import AuthToken, Role, User, Student, Lecturer  # noqa
from app.models.academic import Programme, Department, Course, Class, ClassSession, ClassShare  # noqa
